...
REQUIRED = [
    ...
    # Три пункта, добавленные Эллой 29.07 после разбора живых экранов. Жирный гротеск в
    # заголовке — то, что рисует любая генерация, и именно от него интерфейс выглядит
    # сгенерированным. Отрицательная разрядка на кириллице слепляет буквы.
