...
2. **Источника для сверки слово в слово больше нет.** Он жил в `extella-toolbar-src`; репозиторий
   закрыт (метка `toolbar-final-2026-08`), `DESIGN_CODE.md` с 04.09.2026 лежит в `extella-os`, но это
...
# DESIGN_CODE.md с 04.09.2026 живёт в `extella-os`, но абзаца-цитаты в нём нет — это канон
