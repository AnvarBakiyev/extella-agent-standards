...
def cab_edition(действие="состояние", подтверждено="нет"):
    ...
    СОСТАВ = [
        ...
        {"имя": "Схемы", "папка": "diagrams", "порт": 34786,
         "listing_id": "87988093-d819-4cd1-83a8-ad614fa12392",
         "проба": "index.html",
         "источник": {"вид": "zip", "тег": "v31.1.8",
                      "адрес": "https://github.com/jgraph/drawio/releases/download/"
                               "v31.1.8/draw.war",
                      "лишнее": ["META-INF", "WEB-INF", "connect"]},
         "зачем": "процессы и оргструктуры картинкой, а не страницей текста"},
