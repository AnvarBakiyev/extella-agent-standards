...
def board_setup(app_name: str = "", version: str = "", token: str = "",
    ...
    """Installer for «Schemes Board». Picks the newest published version,
    ...
    LISTING = "d117273e-9f8a-46bd-9410-1e2c2f750a07"
    APP = (app_name or "").strip() or os.environ.get("EXTELLA_APP_NAME") or "Schemes Board"
    ...
    workdir = tempfile.mkdtemp(prefix="extella_board_")
