# ОБНОВЛЁН 20.08.2026 (вечер): код заменён на общий доставщик form_to_app
# (получатель по умолчанию — доска), описание отправляет агентов за таблицами
# к form_to_app. Причина: агент CSO в живой сессии чата упорно слал «в
# таблицу» на доску — контекст беседы сильнее нового правила, а этот эксперт
# умел только доску. Актуальный код = experts/form_to_app.py с дефолтом
# куда="доска"; ниже — исторический однополучательный вариант.
#
